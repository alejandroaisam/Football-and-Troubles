...
First, we need create a sequence that accounts for all the days ranging from the first of January 1980 to the 31st of December 1995. i.e. the period of study. 
...
It has to be mention that this new table is not the definitive dataframe for all of the analyses. It is the general one that accounts for all the variables needed. Then, minor changes will be done at each section to have the specifics needed for each study. 